...
// double App3DhcpBasal::site_energy(int i)
// {
//   int isite = spin[i];
//   int eng = 0;
...
// void App3DhcpBasal::site_event_rejection(int i, RandomPark *random)
// {
//   int oldstate = spin[i];
...
// double App3DhcpBasal::site_propensity(int i)
// {
//   // event = spin flip
...
// void App3DhcpBasal::site_event(int i, RandomPark *random)
// {
//   int m;
...
// int App3DhcpBasal::site_spin (int i) {
//   if ((i<0)||(i>nlocal))

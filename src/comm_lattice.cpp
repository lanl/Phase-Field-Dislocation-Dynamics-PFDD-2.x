...
CommLattice::CommLattice(PFDD_C *pfdd_p) : Pointers(pfdd_p)
{
...
void CommLattice::init(int neighlayer, int *array) 
{
  delghost = neighlayer;
  delreverse = neighlayer;

  //App *applattice = (AppLattice *) app;

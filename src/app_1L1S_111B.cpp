...
// double App1L1S111B::site_energy(int i)
// {
//   int isite = spin[i];
//   int eng = 0;
...
// void App1L1S111B::site_event_rejection(int i, RandomPark *random)
// {
//   int oldstate = spin[i];
...
// double App1L1S111B::site_propensity(int i)
// {
//   // event = spin flip
...
// void App1L1S111B::site_event(int i, RandomPark *random)
// {
//   int m;
...
// int App1L1S111B::site_spin (int i) {
//   if ((i<0)||(i>nlocal))

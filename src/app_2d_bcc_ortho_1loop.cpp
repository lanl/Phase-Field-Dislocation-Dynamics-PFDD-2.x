...
// double App2Dbcc1LORTHO::site_energy(int i)
// {
//   int isite = spin[i];
//   int eng = 0;
...
// void App2Dbcc1LORTHO::site_event_rejection(int i, RandomPark *random)
// {
//   int oldstate = spin[i];
...
// double App2Dbcc1LORTHO::site_propensity(int i)
// {
//   // event = spin flip
...
// void App2Dbcc1LORTHO::site_event(int i, RandomPark *random)
// {
//   int m;
...
// int App2Dbcc1LORTHO::site_spin (int i) {
//   if ((i<0)||(i>nlocal))
